...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-center rounded-lg bg-[var(--bg)] p-1 text-[var(--text-muted)]',
      className
    )}
    {...props}
  />
